    ...
    return (
        <SectionStyle isMobileSize={isMobileSize} visualNo={visualNo}>
            <div className=' max-md:container max-md:mx-auto'>
                <div className='visual max-md:flex max-md:justify-center max-md:mt-[27.733vw] max-md:mb-[8vw]'>
                    <img
                        className='w-[48vw] md:w-[24.514vw]'
                        src={`assets/images/about/logo_about.png`}
                        alt='visual image'
                    />
                </div>
                <div className='top'>
                    <div className='title text-[12vw] leading-[17.341vw] md:text-[6.528vw] md:leading-[9.433vw] uppercase mb-[5.333vw] md:mb-[1.389vw]'>
                        ABOUT
                    </div>
                    <div
                        className='subtitle text-[6.400vw] md:text-[2.083vw] leading-[10.667vw] md:leading-[3.403vw] mb-[8vw] md:mb-[2.083vw] font-bold'
                        dangerouslySetInnerHTML={{
                            __html: `アーティスト・クリエイターすべてが <br class='md:hidden'> デジタルという陽の下、輝ける時代に—。`,
                        }}
                    />
                    <p
                        className='mb-[8vw] md:mb-[1.389vw] text-[4.267vw] md:text-[1.111vw] leading-[8vw] md:leading-[2.083vw] font-medium'
                        dangerouslySetInnerHTML={{
                            __html: `マーケットプレイス「HINATA」は、</br>
                    すべてのアーティスト・クリエイター達が輝ける、デジタルという陽の当たる場所。`,
                        }}
                    />
                    <p
                        className='mb-[8vw] md:mb-[1.389vw] text-[4.267vw] md:text-[1.111vw] leading-[8vw] md:leading-[2.083vw] font-medium'
                        dangerouslySetInnerHTML={{
                            __html: `NFTが開く新しいデジタルの世界は、あなたの可能性を無限に広げてくれます。`,
                        }}
                    />
                    <p
                        className='mb-[8vw] md:mb-[1.389vw] text-[4.267vw] md:text-[1.111vw] leading-[8vw] md:leading-[2.083vw] font-medium'
                        dangerouslySetInnerHTML={{
                            __html: `「HINATA」で、<br class='md:hidden'>あなたの創造性を次の次元に<br class='md:hidden'>引き上げてみませんか。`,
                        }}
                    />
                    <div className='max-md:mb-[20vw] max-md:flex max-md:flex-col max-md:items-center mt-[18.733vw] md:mt-[4.8vw]'>
                        <ButtonOrange
                            href='/profile'
                            size='w-[59.200vw] md:w-[24.167vw] h-[8.533vw] md:h-[2.222vw]'
                            title='NEW ACCOUNT'
                            className='uppercase max-md:mt-[4vw]'
                            classTitle='text-[3.733vw] md:text-[0.972vw] leading-[5.395vw] md:leading-[1.405vw]'
                            classWrapLink=''
                            marginT=''
                        />
                        <ButtonOrange
                            ...
                            size='w-[59.200vw] md:w-[24.167vw] h-[8.533vw] md:h-[2.222vw]'
                            title='COMPANY'
                            className='uppercase max-md:mt-[4vw] md:mt-[1vw]   bg-transparent border border-black shadow-transparent text-black'
                            classTitle='text-[3.733vw] md:text-[0.972vw] leading-[5.395vw] md:leading-[1.405vw] text-black'
                            classWrapLink=''
                            marginT=''
                        />
                    </div>
            ...
            <div className='max-md:hidden scroll'>
...
const SectionStyle = styled.div<{ isMobileSize: boolean; visualNo: number }>`
    ...
    .top {
        ...
        width: ${(props) => (props.isMobileSize ? '' : '42.2vw')};
        left: ${(props) => (props.isMobileSize ? '' : '17%')};
        text-align: left;
        font-family: 'Jost';
        // font-weight: bold;
        z-index: 20;
    ...
    .visual {
        ...
        top: ${(props) => (props.isMobileSize ? '' : '50%')};
        transform: ${(props) => (props.isMobileSize ? '' : 'translate(0, -50%)')};
        right: ${(props) => (props.isMobileSize ? '' : '12.5%')};
        z-index: 20;
    }
    .particles {
        position: absolute;
        overflow: hidden;
        bottom: ${(props) => (props.isMobileSize ? '72%' : '0')};
        right: 0;
        z-index: 0;
    ...
    .orbit {
        position: absolute;
        bottom: ${(props) => (props.isMobileSize ? '11.3%' : '0')};
        width: ${(props) => (props.isMobileSize ? '122%' : '100%')};
        height: 60%;
        display: flex;
        ...
        opacity: 0;
        .svg-orbit {
            height: ${(props) => (props.isMobileSize ? '50vw' : '')};
        }
    }
`;
