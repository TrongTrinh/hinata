...
const CategoryPage = () => {
    ...
    return (
        <>
            ...
            {/* grid-area: a; align-self: center; justify-self: center; */}
            <div>
                <div className='flex flex-col justify-center items-center sm:grid   grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-3 gap-y-[4rem] md:gap-y-[7rem] mt-2.6 md:mt-[8.6rem]'>
                    {data &&
                        data.map((item, index) => (
                            <CategoryItem
