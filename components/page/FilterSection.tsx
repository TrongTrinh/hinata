...
const PageFilter: FC<IPageFilterProps> = ({ className, items, itemActive, handleClick }) => {
    ...
    return (
        <PageFilterStyle
            className={classnames(
                'px-1.2 md:px-3 py-[0.65rem] md:py-1.4 flex items-center justify-between rounded-lg',
                className,
            )}
        >
            {!isTabletOrMobile ? (
                ...
                >
                    <ButtonOrange
                        ...
                        size='w-auto h-[3.2rem]'
                        classTitle='mr-2.5 ml-0 font-nato'
            ...
            <DropdownDefault overlay={<SearchFilterBox />} visible={visibleSearchBox} onVisibleChange={onShowRight}>
                <ButtonOrange
                    ...
                    marginT='mt-0'
                    size='w-[11rem] md:w-[22rem] h-[3.2rem]'
