    ...
    return (
        <CateforyItemStyle
            className={classNames(
                `category-position-${positionItem} relative w-[25.7rem] h-[37.5rem] clear-both`,
                className,
            )}
        >
            <Image
                className='absolute left-[10.644rem]'
            ...
            <div className='absolute left-[15rem] tracking-[0.4rem] top-0.5 flex items-center'>
                <Image
                    className=''
                    alt='category frame 1'
                    width={10}
            ...
            <Image
                className='absolute top-[2.99rem] left-[1.679rem]'
            ...
            />
            <Image
                className='absolute top-[2.7rem] left-[1.3rem]'
                alt='category frame 3'
                width={257}
                height={257}
                src={`/assets/images/category/frame-${image3}-3.svg`}
            />
            <div className='mask absolute top-[2.7rem] left-[1.3rem]'>
                <img
                    alt='category frame 3'
                    src={
                        // @ts-ignore
